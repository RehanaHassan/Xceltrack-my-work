        ...
        <div className="flex gap-40 w-max animate-scroll-right group-hover:[animation-play-state:paused]">
          {allFeatures.map((feature, index) => (
            <div key={index} className="group/card relative w-[350px] flex-shrink-0">
              ...
              <div
                className="absolute inset-0 bg-gray-400 rounded-2xl transform rotate-3 translate-y-2 translate-x-2 -z-10 transition-transform duration-300"
              ></div>

              <div
                className="hover-card-blue border-2 border-sapphire-900/30 p-8 rounded-2xl h-full shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]"
              >
